        ...
        <nav class="bg-gray-800 shadow-md py-4">
            <div class="container mx-auto md:px-0">
                <div class="flex items-center justify-around">
                    <a class="text-2xl text-white ml-2" href="{{ url('/') }}">
                        TCU Ulatina
                    </a>
                    ...
                    <nav class="flex-1 text-right">
                            ...
                            <a
                                ...
                                class="bg-green-500 rounded-full mr-1 px-3 py-1 font-bold text-sm text-white"
                            > {{ Auth::user()->unreadNotifications->count()}}</a>
                            @endif

                                            <a class="no-underline hover:underline text-gray-300 p-3" href="{{ route('logout') }}"
