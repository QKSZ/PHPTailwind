                     ...
                     <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="email" class="block text-gray-700 text-sm mb-2">{{ __('E-Mail Address') }}</label>
                                ...
                                <input id="email" type="email" class="p-3 bg-gray-200 form-input w-full @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password" class="block text-gray-700 text-sm mb-2">{{ __('Password') }}</label>
                                ...
                                <input id="password" type="password" class="p-3 bg-gray-200 form-input w-full @error('password') is-invalid @enderror" name="password"  autocomplete="current-password">
